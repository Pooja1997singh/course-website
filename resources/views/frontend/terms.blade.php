                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Term & Conditions</span>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-11">
                        ...
                        <h1></h1>
                        <p style="font-family:gordita; color: #000;margin-bottom: 20px;text-align: left;font-size: 16px;line-height: 20px;">
                            Last updated: December, 2023</p>
                        <p style="font-family:gordita; color: #000;margin-bottom: 20px;text-align: left;font-size: 16px;line-height: 20px;">
                            Please read these terms and conditions carefully before using Our Service.</p>

                        <h3 style="margin-bottom: 15px;">Interpretation</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 20px;text-align: left;font-size: 16px;line-height: 20px;">
                            The words of which the initial letter is capitalized have meanings defined under the following
                            conditions. The following definitions shall have the same meaning regardless of whether they
                            appear in singular or in plural.</p>
                        <h3 style="margin-bottom: 15px;">Definitions</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 20px;text-align: left;font-size: 16px;line-height: 20px;">
                            For the purposes of these Terms and Conditions:</p>
                        <ul>
                            <li>
                                <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                            ...
                            <li>
                                <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                                    ...
                                    "Us" or "Our" in this Agreement) refers to dotfy.me.
                                </p>
                            </li>
                            <li>
                                <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                            ...
                            <li>
                                <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                                    <strong>Website</strong> refers to dotfy.me, accessible from <a href="https://dotfy.me/" rel="external nofollow noopener" target="_blank" style="letter-spacing: 2px;">https://dotfy.me/</a>
                                </p>
                            </li>
                            <li>
                                <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;"> Acknowledgment</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Links to Other Websites</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Termination</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Limitation of Liability</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                            ...
                            by law.</p>
                        <h3 style="margin-bottom: 15px;">"AS IS" and "AS AVAILABLE" Disclaimer</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Governing Law</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Disputes Resolution</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">For European Union (EU) Users</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">United States Legal Compliance</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Severability and Waiver</h3>
                        <h3 style="margin-bottom: 15px;">Severability</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                            ...
                            effect.</p>
                        <h3 style="margin-bottom: 15px;">Waiver</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                        ...
                        <h3 style="margin-bottom: 15px;">Translation Interpretation</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 7px;text-align: left;font-size: 16px;line-height: 20px;">
                            These Terms and Conditions may have been translated if We have made them available to You on our
                            Service.
                            You agree that the original English text shall prevail in the case of a dispute.</p>
                        <h3 style="margin-bottom: 15px;">Changes to These Terms and Conditions</h3>
                        <p style="font-family:gordita; color: #000;margin-bottom: 15px;text-align: left;font-size: 16px;line-height: 20px;">
